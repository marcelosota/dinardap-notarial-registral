...
public class TramitesPendientesRegistrosCtrl extends BaseCtrl {
    ...
    private void subirArchivo() {
        try {
            ...
            if (tramiteSelected != null) {
                ...
                documentoDto.setContenido(IOUtils.toByteArray(file.getInputstream()));
    ...
    public void descargarActoNotarial() {
        try {
            ...
            documento = documentoServicio.buscarPorTramiteRegistros(tramiteSelected.getTramite().getTramiteId(),
